...
./prepare.py 0.004 501 100,100 0.02,0.02 $NAME 500 000500
./single_run.sh
./prepare.py 0.002 1001 200,200 0.01,0.01 $NAME 1000 001000
./single_run.sh
./prepare.py 0.001 2001 400,400 0.005,0.005 $NAME 2000 002000
./single_run.sh
./prepare.py 0.0005 4001 800,800 0.0025,0.0025 $NAME 4000 004000
./single_run.sh
./prepare.py 0.00025 8001 1600,1600 0.00125,0.00125 $NAME 8000 008000
./single_run.sh
